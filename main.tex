...
\begin{enumerate}
\item Tentukan nilai maksimum f(x,y) = 3x + 4y pada himpunan penyelesaian sistem pertidaksamaan berikut: x + 2y <= 10, 4x + 3y <= 24, x >= 0, y >= 0.
\item Tentukan nilai maksimum dan nilai minimum dari fungsi objektif z = 2x + 3y yang memenuhi x + y <= 7, x >= 0, dan y >= 0, x, y anggota R.
